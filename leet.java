...
class Solution {
// naukri.com 
// leetcode -> 1problem daily 8 lpa -> switch 
  ...
  static int bfs(Map<String,List<String>> graph,String[] words,String source, String target){
   ...
   // Syetem.out.println(graph);
    //return bfs(graph,words,source,target);
   // {but=[put], lot=[pot], pot=[put, pog, lot], pog=[pot, dog], dog=[pog], put=[but, pot]}
    
	}

	public static void main(String[] args) {
	//shortestWordEditPath("bit","dog",new String[]{"but", "put", "big", "pot", "pog", "dog", "lot"});
    shortestWordEditPath("no","go",new String[]{"to"});
	}
}